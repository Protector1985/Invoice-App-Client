...
import {useUpdateCommandMutation} from '../../../../Redux/services/invoiceDataService'
...
function Fullinvoice(props) {
    ...
    const [submitTrigger,{ endpointName , data,  isError, isUninitialized, isSuccess, error}] = useUpdateCommandMutation()
            ...
            if(width >= 768) {
                ...
                isLoading ? <Spinner /> :
                    ...
                    <div className={darkMode ? invoiceDarkCSS.centerContainer : invoiceCSS.centerContainer}>
                        ...
                        <div className={darkMode ? invoiceDarkCSS.centerMiddle : invoiceCSS.centerMiddle}>
                        ...
                        <div className={darkMode ? invoiceDarkCSS.centerRight : invoiceCSS.centerRight}>
                                <p className={darkMode ? invoiceDarkCSS.invoiceHeadline :invoiceCSS.invoiceHeadline}>Sent to</p>
                                <h3 className={darkMode ? invoiceDarkCSS.invoiceData : invoiceCSS.invoiceData}>{invoice.toEmail}</h3>
                        </div>
                    </div>
                ...
                return (
                    isLoading ? <Spinner /> :
                        ...
                        <div className={darkMode ? invoiceDarkCSS.btnContainer : invoiceCSS.btnContainer}>
                ...
                return (
                    isLoading ? <Spinner /> :
                        ...
                        <div className={darkMode ? invoiceDarkCSS.btnContainer : invoiceCSS.btnContainer}>
                                <Button description="Edit" mode={darkMode ? "dark" : "light"} type={3} invoiceNumber={invoiceNumber}  />
                                <Button description="Delete" invoiceNumber={invoiceNumber} clicked={submitTrigger} mode="light" type={5} />
                                <Button description="Mark as Paid" mode={darkMode ? "dark": "light"} invoiceNumber={invoiceNumber} clicked={submitTrigger}  type={2} />
                        </div>
                    </div>
                    )
            } else if (width < 492) {
                        ...
                        <div className={darkMode ? invoiceDarkCSS.bottomContainer : invoiceCSS.bottomContainer}>
                            <div className={darkMode ? invoiceDarkCSS.breakdown : invoiceCSS.breakdown}>
                                ...
                                <div className={darkMode ? invoiceDarkCSS.itemNameContainer : invoiceCSS.itemNameContainer}>
                                    {invoice.services.map((item) => {
                                        return (
                                            <div className={darkMode ? invoiceDarkCSS.smallItemRow : invoiceCSS.smallItemRow}>
                                                <div className={darkMode ? invoiceDarkCSS.smallItemAndPrice : invoiceCSS.smallItemAndPrice}>
                                                    <p className={darkMode ? invoiceDarkCSS.itemName : invoiceCSS.itemName}>{item.description}</p>
                                                    <p className={darkMode ? invoiceDarkCSS.itemAmountandPrice : invoiceCSS.itemAmountandPrice}>{`${item.qty}x $${dollarAmount(item.pricePerItem.toFixed(2))}` }</p>
                                                </div>
                                                    <p className={darkMode ? invoiceDarkCSS.itemName : invoiceCSS.itemName}>${dollarAmount((item.pricePerItem * item.qty).toFixed(2))}</p>
                                            </div>
